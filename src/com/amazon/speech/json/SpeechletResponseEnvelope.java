...
/**
 * Envelope to wrap the response of a {@code Speechlet} invocation as well as mutable elements of
 * the {@code Speechlet} invocation parameters.
 *
...
public class SpeechletResponseEnvelope {
    ...
    /**
     * Returns the {@code Speechlet} response.
     *
     * @return the response
     */
    ...
    /**
     * Sets the {@code Speechlet} response.
     *
     * @param response
     *            the response to set
     */
